...
public class DownloadDataTask extends AsyncTask<Void, Integer, String>{
	...
	public DownloadDataTask(String url, List<NameValuePair> params, Context appcontext){
		this.url = url;
		this.params = params;
	...
	protected String doInBackground(Void... para) {
			...
			try {
				...
				retSrc = retSrc.substring(retSrc.indexOf("{")+1,retSrc.indexOf("}"));
			...
			protected void onPostExecute(String result) {
				...
				editor.putString("downloaddata",result);
				editor.commit();
			}
}